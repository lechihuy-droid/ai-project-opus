...
**Khi nào dùng full SDD (RD → SD → BD, mỗi bước chờ APPROVE):** project mới từ đầu, feature lớn nhiều tuần, hoặc thay đổi kiến trúc. Task thông thường KHÔNG cần RD/SD — chỉ cần plan/BD ngắn rồi implement theo brief được giao.
