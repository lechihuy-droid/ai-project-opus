...
```text
personal-finance/PERSONAL_FINANCE_PLAN_JP_v0.md
personal-finance/FINANCE_DATA_STORAGE_POLICY.md
```
...
```text
personal-finance/snapshots/YYYY-MM-finance-snapshot.md
personal-finance/reviews/YYYY-MM-review.md
personal-finance/decisions/YYYY-MM-nisa-ideco-decision.md
```
