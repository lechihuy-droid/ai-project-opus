...
aliases: ["Current Context", "Operating Context"]
topic: Personal
tags: [decision-brain, opus-animus, lucida, context]
status: evergreen
confidence: medium
sources: []
...
## Summary
This page tells Codex what the wiki should optimize for when turning sources into recommendations.

## Key Points
- Opus Animus: personal operating system and strategic workspace.
...
## Details
When reading wiki sources, Codex should ask:
- Does this change how Opus Animus should be built or operated?
- Does this suggest a Lucida workflow improvement?
- Does this change Huy's re-skill roadmap?
