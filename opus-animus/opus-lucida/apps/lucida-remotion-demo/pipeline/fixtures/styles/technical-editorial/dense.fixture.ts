...
export const technicalEditorialDenseFixture: TechnicalEditorialFixture = {
  ...
  title:
    "Condense a dense technical recap into one portrait frame without collapsing the reading order",
  summary:
  ...
  annotations: [
    {
      ...
      note: "Readers need contracts over mood boards.",
      tone: "accent",
    },
    {
      label: "Density",
      value: "Three evidence rails",
      note: "Diagram, metrics, and steps each carry one claim.",
      tone: "neutral",
    },
    {
      label: "Fallback",
      value: "Reduced motion; honest metrics",
      note: "Opacity-led entry stays deterministic; numbers stay descriptive.",
      tone: "success",
    },
  ],
  metrics: [
    ...
    },
    {
      label: "Copy",
      value: "414c",
      detail: "Distributed across labeled surfaces, not one paragraph",
      tone: "warning",
    },
  ],
  diagram: {
    title:
      "Technical editorial scenes stay legible by assigning each fact to one lane",
    subtitle:
    ...
    nodes: [
      {
        ...
        detail:
          "Name the system, the decision point, and the reason this frame exists.",
        tone: "accent",
      },
      {
        kicker: "02 / Partition",
        ...
        detail:
          "The diagram shows the actual flow. The left rail keeps notes short and inspectable.",
        tone: "neutral",
      },
      {
        kicker: "03 / Verify",
        ...
        detail:
          "Review PNGs and report fields describe exactly what was rendered and tested.",
        tone: "success",
      },
    ],
    connectors: ["assign lanes", "record outputs"],
  },
  code: {
  ...
  steps: [
    ...
    },
    {
      ...
      detail:
        "Annotations, metrics, and code each carry one type of information.",
    },
    {
      index: "B3",
      label: "Leave review breadcrumbs",
      detail:
        "Every output is discoverable from provenance and artifact manifest paths.",
    },
  ],
  footer: {
