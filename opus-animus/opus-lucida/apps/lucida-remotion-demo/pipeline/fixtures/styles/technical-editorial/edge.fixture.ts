...
export const technicalEditorialEdgeFixture: TechnicalEditorialFixture = {
  ...
  title:
    "Handle long technical labels, compliance notes, and renderer caveats without breaking the grid",
  summary:
  ...
  metrics: [
    ...
    },
    {
      ...
      value: "Static",
      detail:
        "Used to verify reduced-motion readability and deterministic layout",
      tone: "neutral",
    },
  ],
  diagram: {
    title:
      "Edge handling keeps the composition honest instead of hiding constraints",
    subtitle:
    ...
    nodes: [
      {
        ...
        detail:
          "State exactly which integration step is outside ownership instead of silently implying completion.",
        tone: "warning",
      },
      {
        kicker: "02 / Adapt",
        ...
        detail:
          "A local Remotion root allows review-frame generation without touching unrelated compositions.",
        tone: "accent",
      },
      {
        kicker: "03 / Deliver",
        ...
        detail:
          "Package validators and TypeScript checks still provide objective evidence for this slice of work.",
        tone: "success",
      },
    ],
    connectors: ["scope around blocker", "report truthfully"],
  },
  code: {
    filename: "family-entry.tsx",
    language: "tsx",
    lines: [
      "const family =",
      "  'technical-editorial';",
      "const root = 'renderRoot.tsx';",
      "bundle({ entryPoint: [family, root].join('/') });",
      "renderStill({ id: 'FamilyReview', frame: 24, sceneKey: 'edge' });",
    ],
  },
  steps: [
    {
    ...
    },
    {
      ...
      detail:
        "Static motion mode ensures edge-case screenshots are directly reviewable.",
    },
    {
      index: "C3",
      label: "Ship package evidence",
      detail:
        "Validator output, render report, and frames are enough for package-level review.",
    },
  ],
  footer: {
