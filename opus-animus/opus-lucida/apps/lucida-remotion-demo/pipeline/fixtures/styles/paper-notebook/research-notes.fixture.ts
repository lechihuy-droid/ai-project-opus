...
export const paperNotebookResearchNotesFixture: PaperNotebookFixture = {
  key: "research-notes", sceneType: "research-notes", sceneLabel: "Research notes", durationInFrames: 180, density: "balanced", motionPolicy: "full",
  eyebrow: "Research notes / visual systems", title: "A notebook frame should expose the reasoning, not decorate the conclusion", subtitle: "A quiet paper field lets the ink hierarchy carry definitions, evidence, and the small corrections that make thinking visible.", dateLabel: "13 JUL 2026", pageLabel: "RESEARCH 01", sectionTitle: "Three working principles",
  notes: [
