...
export const PaperNotebookRemotionRoot = () => <Composition id={PAPER_NOTEBOOK_COMPOSITION_ID} component={PaperNotebookPreview} width={1080} height={1920} fps={30} durationInFrames={paperNotebookFixtures["research-notes"].durationInFrames} defaultProps={{ sceneKey: "research-notes" }} calculateMetadata={calculateMetadata} />;
