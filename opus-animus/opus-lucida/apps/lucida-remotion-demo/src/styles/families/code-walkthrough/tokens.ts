...
export const codeWalkthroughTokens = createStyleCoreTokens({
  meta: { familyId: "code-walkthrough", version: "0.1.0" },
  color: {
    canvas: "#101318",
    canvasRaised: "#171C22",
    surface: "#151A20",
    surfaceElevated: "#1D242C",
    surfaceOverlay: "rgba(16, 19, 24, 0.96)",
    textStrong: "#F3F6F8",
    textMuted: "#B8C2CC",
    textSoft: "#84909C",
    accent: "#65BEE8",
    accentSoft: "rgba(101, 190, 232, 0.14)",
    success: "#66C892",
    warning: "#E5B567",
    danger: "#EB7C86",
    rule: "rgba(243, 246, 248, 0.13)",
