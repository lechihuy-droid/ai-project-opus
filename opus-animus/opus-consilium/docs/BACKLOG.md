...
| Opt-3 | Hermes Skill Layer (A+B) | Wrap Module A+B thành Hermes skills | 🔬 Evaluated 2026-06-11 — `opus-animus/docs/EVAL-hermes-agent-integration.html`, chờ approve RD |
