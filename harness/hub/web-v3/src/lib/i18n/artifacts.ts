...
export const artifacts = {
  ...
  'artifacts.tab.output': 'Output', 'artifacts.tab.versions': 'Versions', 'artifacts.current': 'current',
  'artifacts.meta.createdBy': 'Created by', 'artifacts.meta.startedAt': 'Started at', 'artifacts.meta.completedAt': 'Completed at',
