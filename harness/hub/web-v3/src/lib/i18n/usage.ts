...
export const usage = {
  ...
  'usage.estimatedCost': 'Estimated cost', 'usage.estimateDisclaimer': 'This is an estimate based on provisional pricing and may not reflect final billing.', 'usage.pricingCoverageUnavailable': 'Pricing coverage: no data available', 'usage.pricingCoverage': '{priced} of tokens incur cost · {unpriced} via included quota (no charge)',
